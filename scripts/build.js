...
const writeStatsJson = argvs.indexOf('--stats') !== -1;
...
// build and stat
function buildApp(currentApp, buildPath, config) {
  return checkBrowsers(buildPath, isInteractive)
    .then(() => {
    ...
    .then(
      ({ stats, previousFileSizes, warnings }) => {
        if (warnings.length) {
          ...
          console.log(chalk.green(`${currentApp.name} Compiled successfully.\n`));
        }
